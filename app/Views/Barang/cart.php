                ...
                <form action="#">
                    <div class="table-content table-responsive">
                        <table>
                            ...
                            <tbody>
                                <?php if (!$cart) : ?>
                                    <td colspan="6" style="font-size: 30px; margin-bottom:5px;">Kamu belum memasukan barang ke keranjang, <a href="/barang/index" class="buttons-cart">Beli</a></td>
                                <?php endif ?>
                                <?php foreach ($cart as $c) : ?>
                                    <tr id="cart-row">
                                        ...
                                        <td class="product-quantity"><?= $c['jumlah']; ?></td>
                                        ...
                                        <td class="product-remove">
                                            <a href="/cart/edit/<?= $c['id']; ?>" class="btn-edit"><span class="ti-pencil"></span></a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
